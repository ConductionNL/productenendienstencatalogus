...
class WestFrieslandFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        */
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particuliere urnennis of urnengraf 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particuliere urnennis of urnengraf 15 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particuliere urnennis of urnengraf 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particuliere urnennis of urnengraf 25 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particuliere urnennis of urnengraf 30 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Afnemen en herplaatsen grafbedekking');
        $koopgrafProduct->setDescription('voor bijzetting in bestaand graf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($hoorn);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Achterlaten grafhout');
        $koopgrafProduct->setDescription('bij islamitisch graf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($hoorn);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Gebruik wachtruimte');
        $koopgrafProduct->setDescription('maximaal 2 uur');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($hoorn);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Rijdende baar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Gebruik touwen');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Gebruik graflift');
        $koopgrafProduct->setDescription('dalen, dalen tot maaiveld, niet dalen');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($hoorn);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Zand & schepje');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Vergunning voor grafsteen');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'d736013f-ad6d-4885-b816-ce72ac3e1384']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Algemeen graf 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($koggenland);
        $koopgrafProduct->setAudience('public');
        $manager->persist($koopgrafProduct);
        $koopgrafProduct->setId($id);
        $manager->persist($koopgrafProduct);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Grafkelder 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Huurgraf 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kindergraf 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnengraf 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kist dalen');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kist dalen maaiveld');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Klok luiden ');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'f050292c-973d-46ab-97ae-9d8830a59d15']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct->setName('Algemeen graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($medemblik);
        $koopgrafProduct->setAudience('public');
        $manager->persist($koopgrafProduct);
        $koopgrafProduct->setId($id);
        $manager->persist($koopgrafProduct);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Babygraf < 1 jaar 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Gedenkteken');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kindergraf > 1 jaar en < 12 jaar 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnengraf 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnennis 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnennis 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Afwijkende maten kist ');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Geluidsinstallatie');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kist dalen i.a.v. familie');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Tijdelijke grafmarkering');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Verwijderd de familie zelf linten, kruisjes e.d. binnen 2 weken');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'429e66ef-4411-4ddb-8b83-c637b37e88b5']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Begraven stoffelijk overschot <1 jaar algemeen graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        $koopgrafProduct->setAudience('public');
        $manager->persist($koopgrafProduct);
        $koopgrafProduct->setId($id);
        $manager->persist($koopgrafProduct);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Begraven stoffelijk overschot <1 jaar particulier graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Begraven stoffelijk overschot <12 jaar algemeen graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Begraven stoffelijk overschot <12 jaar particulier graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kindergraf <12 jaar 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Kindergraf <12 jaar 30 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Onderhoudsrechten 10 jaar');
        $koopgrafProduct->setDescription('T.b.v. (urnen)graf, algemeen graf en een kindergraf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Onderhoudsrechten 20 jaar');
        $koopgrafProduct->setDescription('T.b.v. (urnen)graf, algemeen graf en een kindergraf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Onderhoudsrechten 30 jaar');
        $koopgrafProduct->setDescription('T.b.v. (urnen)graf, algemeen graf en een kindergraf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particulier graf bestaand 20 jaar');
        $koopgrafProduct->setDescription('bijplaatsing');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particulier graf bestaand 30 jaar');
        $koopgrafProduct->setDescription('bijplaatsing');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particulier graf nieuw 20 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Particulier graf nieuw 30 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnengraf  20 jaar');
        $koopgrafProduct->setDescription('aardgraf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Urnengraf  30 jaar');
        $koopgrafProduct->setDescription('aardgraf');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Verlengen kindergraf 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Verlengen particulier grafrecht 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Verlengen urnengraf 10 jaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Draagbaar');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Grafgroen');
        $koopgrafProduct->setDescription('Afdekken van het graf met grafgroen');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Klok luiden');
        $koopgrafProduct->setDescription('klokluiden i.o.m. betreffende stichting');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        $koopgrafProduct->setCatalogue($opmeer);
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Touwen & balkjes');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
        ...
        $koopgrafProduct = new Product();
        $koopgrafProduct->setName('Zelf afrollen steen bestaand graf');
        $koopgrafProduct->setDescription('');
        $koopgrafProduct->setSourceOrganization($this->commonGroundService->cleanUrl(['component'=>'wrc', 'type'=>'organizations', 'id'=>'16fd1092-c4d3-4011-8998-0e15e13239cf']));
        $koopgrafProduct->setType('simple');
        $koopgrafProduct->setRequiresAppointment('false');
